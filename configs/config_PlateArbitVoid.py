...
# Plate/beam geometry
parser.add_argument("--plate_length", type=float, default=1.0, help="Plate length")
parser.add_argument("--plate_width", type=float, default=1.0, help="Plate width")
...
model_data["filename"] = (
    f"TO_cantilever_LxW_{plate_length}x{plate_width}_s"
    f"{model_data['beam']['numPtsU']}x{model_data['beam']['numPtsV']}_n"
    f"{model_data['n_dataset']}"
)
# model_data["filename"] = f"TO_cantilever_LxW_1.0x1.0_s200x200_n10"
